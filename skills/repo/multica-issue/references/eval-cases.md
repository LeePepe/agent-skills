...
|---|---|---|
| C1 feature | New capability in a repo with Spec Kit | specify → clarify → plan → tasks; references constitution; tasks mapped to repository-defined PR/layer units with real blockers/stages; no speckit-implement |
...
| S1 cross-layer | Data change plus UI consumption | Dependency-ordered repository units with necessary companion tests/docs, each with actual red_lines and gate commands |
